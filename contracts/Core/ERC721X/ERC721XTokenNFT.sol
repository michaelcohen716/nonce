...
contract ERC721XTokenNFT is ERC721, SupportsInterfaceWithLookup {
    ...
    function tokenByIndex(uint256 _index) public view returns (uint256) {
        require(_index < totalSupply(), "token index not found");
    ...
    function _transferFrom(address _from, address _to, uint256 _tokenId)
        internal
    {
        require(tokenType[_tokenId] == NFT, "Not an NFT");
        require(isApprovedOrOwner(_from, ownerOf(_tokenId), _tokenId), "Not approved or owner");
    ...
    function approve(address _to, uint256 _tokenId) public {
        ...
        require(_to != owner, "Can't send to owner");
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "Sender must be valid approver or sender");
